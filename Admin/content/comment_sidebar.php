...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="index.php"><em class="fa fa-mobile-phone icon">&nbsp;</em>Product List</a></li>
			<li><a href="account.php"><em class="fa fa-user icon">&nbsp;</em>Account List</a></li>
			<li class='active'><a href="comment.php"><em class="fa fa-comment icon">&nbsp;</em>Comment List</a></li>
