	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo $level.IMG."bg-01.jpg"?>');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				...
				<form class="login100-form validate-form flex-sb flex-w" action='<?php echo $level.CONT.'dangnhap.php'; ?>' method="get" onsubmit="return validateform()">
						...
						<i style="color:red">
							<?php
								...
								if(isset($_GET['status']))
								{
									...
									else echo "Đăng kí thành công! Vui lòng đăng nhập tại đây.";
								}
					...
					<div class="container-login100-form-btn m-t-17">
						<button type="submit" class="login100-form-btn" name="singin">
							Sign In
						</button>
					</div>
